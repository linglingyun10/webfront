...
(function () {
	...
	window.DrawFluidWater = function (parentElemntId, options) {
		...
		var defaults = {
			...
			currentCount : 800, //  当前的数
			strokeStyle : "#d5edea", // 水边框颜色
	...
	DrawFluidWater.prototype = {
		...
		drawOverLay : function () {
			var _this = this;
			_this.drawOverLay = _this.parent.paper.image("img/icon01.png",672, 71,408,408);
			_this.parent.append(_this.drawOverLay);
			return _this.drawOverLay;
		},
		getDynamicPoint : function (num) {
		     var wave = {
					wave1 :"M670.5,"+(82.969+388*(1-num))+ "c0,0,78.001,43.802,215.334,0"+"s195.564,0,195.564,0"+"L1080.5,748.5"+"h"+(0-(811.952-401*(1-num)))+"V"+(82.969+388*(1-num))+"z",//第一种形状的波纹
					wave2 : 
					"M670.5,"+(82.969+388*(1-num))+ "c0,0,78.349-44.878,215.334,0"+
			        "c120.666,39.531,195.564,0,195.564,0"+
			        "L1080.5,678.5"+
			       	"h"+(0-(811.952-401*(1-num)))+
			        "V"+(82.969+388*(1-num))+
			        "z",//第二种形状的波纹
					normal : "M811.952,470.74c0,0,32.751,7.716,69.595,2c37.001-5.74,58.398-2,58.398-2l-0.236,148.636H811.952V470.74z",
					reset : 
					"M811.952,470.74,"+
		...
		drawLightRing : function () {
			...
			var animatation = _this.parent.paper.el("animate",{
				attributeType: "xml",
				attributeName: "r",
				from: 220.002,
				to: 310.002,
			...
			var animatation2 = _this.parent.paper.el("animate",{
				attributeType: "xml",
				attributeName: "r",
				from: 250.002,
				to: 310.002,
			...
			var animatation3 = _this.parent.paper.el("animate",{
				attributeType: "xml",
				attributeName: "r",
				from: 280.002,
				to: 310.002,
		   ...
		   _this.lineRing3.append(animatation3);
		   _this.lineRing2.append(animatation2);
		    _this.lineRing.append(animatation);
