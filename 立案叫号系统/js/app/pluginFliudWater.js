	...
	DrawFluidWater.prototype = {
        ...
        * */
        drawMyReception: function() {
            ...
            _reception.value = _this.parent.text(_textX, _textY + 90, _this.opts.myReception).attr({
                fill: '#fff',
                textAnchor: 'middle',
                fontSize: '94px',
                fontFamily: 'Arial',
        ...
        * */
        drawTakeNum: function() {
            var _this = this;
            var _x = _this.opts.centerPoint.cx-50,
                _y = _this.opts.centerPoint.cy + _this.opts.ballR - 85;
            _this.takeNum = _this.parent.paper.image("images/icon05.png", _x, _y, 123, 32).attr({
				cursor: 'pointer'
            }).click(function() {
            	if(!_this.opts.isStop) {
        ...
        **/
		...
		drawPlayBtn: function(){
            ...
            var _imgW, _imgH;
             _imgW = _imgH = 410;
			_this.drawPlayBtn1 = _this.parent.paper.image("images/icon03.png", _imgX, _imgY, _imgW, _imgH).attr({
				cursor: "pointer"
			}).click(function(event,target) {
				$('#ztbtn').show();
				_this.opts.isStop = false;
				_this.drawPlayBtn1.remove();
            });
			_this.parent.append(_this.drawPlayBtn1);
			return _this.drawPlayBtn1;
		},
        /*
        * 判断对象是否是方法
        ...
        * */
		...
		update : function (updateCount) { //updateCount 
			//0----1之间的小数
			var _this = this;
